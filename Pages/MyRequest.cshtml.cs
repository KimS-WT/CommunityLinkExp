...
namespace CommunityLink.Pages
{
    public class MyRequestModel : PageModel
    {
        ...
        public MyRequestModel(CommunityLinkDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> OnPostBackAsync(int pageIndex)
        {
            ...
            return RedirectToPage("/MyRequest", new { pageIndex = CurrentPage });
        }
        ...
        public async Task<IActionResult> OnPostAddRequestAsync()
        {
            ...
            var requestor = await _context.Requestors.FindAsync(ThisUser.Requestor.RequestorID);
            ...
            var newRequest = new Request
            {
                ...
                Requestor = requestor, // Set the Requestor navigation property
            ...
            // Repopulate the requests list
            Requests = await _context.Requests
                                     .Where(r => r.RequestorID == ThisUser.Requestor.RequestorID)
                                     .ToListAsync();
